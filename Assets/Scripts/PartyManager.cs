...
public class PartyManager : MonoBehaviour
{
    ...
    public void AddCharacterToBattleParty(Character character)
    {
        Debug.Log("Add Character to BattleParty: " + character);
        if (!BattlePartymembers.Contains(character.characterData) && BattlePartymembers.Count < maxBattlePartySize)
        {
            ...
            BattlePartymembers.Add(character.characterData);
        }
        else
        {
    ...
    public void RemoveCharacterFromActiveParty(Character character)
    {
        if (activePartyMembers.Contains(character.characterData))
        {
            activePartyMembers.Remove(character.characterData);
        }
    }

    public void RemoveCharacterFromBattleParty(Character character)
    {
        if (BattlePartymembers.Contains(character.characterData))
        {
            BattlePartymembers.Remove(character.characterData);
